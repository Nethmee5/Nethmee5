...
<p>Back-end programming languages/frameworks & Databases:</p>
<p>NodeJS, PHP, Java, Spring Boot, C#, .NET/.NET Core, .NET Framework, SQL Server, Relational Databases (MySQL) </p>
